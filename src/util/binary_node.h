...
const KeyValuePair *binary_node_predecessor(const BinaryNode *, Compare, const void *k);
const KeyValuePair *binary_node_successor(const BinaryNode *, Compare, const void *k);
